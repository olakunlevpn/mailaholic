[Setup]
AppName=Mailaholic
AppVerName=Mailaholic 5.4-B1929
AppCopyright=Copyright (C) 2008
DefaultDirName={pf}\Mailaholic
DefaultGroupName=Mailaholic
PrivilegesRequired=admin
OutputBaseFilename=Mailaholic-5.4-B1929
...
; Main server
Source: "..\source\server\Mailaholic\Release\Mailaholic.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "..\source\server\Mailaholic\Release\hMailServer.tlb"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "..\source\server\Mailaholic\Release\Mailaholic.Minidump.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server;
...
; Languages
Filename: "{app}\Bin\Mailaholic.ini"; Section: "GUILanguages"; Key: "ValidLanguages"; String: "english,swedish"; Flags: createkeyifdoesntexist; 
...
Filename: "{app}\Bin\hMailAdmin.exe";  Flags: skipifsilent postinstall nowait; Description: Run Mailaholic Administrator; Components: admintools;
