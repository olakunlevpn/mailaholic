[Files]
; Main server
Source: "..\source\server\Mailaholic\x64\Release\Mailaholic.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "..\source\server\Mailaholic\x64\Release\hMailServer.tlb"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "..\source\server\Mailaholic\x64\Release\Mailaholic.Minidump.exe"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server;
