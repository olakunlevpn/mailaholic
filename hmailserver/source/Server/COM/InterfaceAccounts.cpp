...
void
InterfaceAccounts::Attach(std::shared_ptr<MA::Accounts> pAccounts)
{
   accounts_ = pAccounts;
}
...
STDMETHODIMP InterfaceAccounts::Delete(long Index)
{
   try
   {
      ...
      std::shared_ptr<MA::Account> pAccount = accounts_->GetItem(Index);
      MA::PersistentAccount::DeleteObject(pAccount);
...
STDMETHODIMP InterfaceAccounts::get_ItemByDBID(long DBID, IInterfaceAccount **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Account> pAccount = accounts_->GetItemByDBID(DBID);
...
STDMETHODIMP InterfaceAccounts::get_ItemByAddress(BSTR Address, IInterfaceAccount **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Account> pAccount = accounts_->GetItemByName(Address);
