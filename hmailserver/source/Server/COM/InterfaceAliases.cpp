...
void
InterfaceAliases::Attach(std::shared_ptr<MA::Aliases> pAliases)
{
   aliases_ = pAliases;
} 
...
STDMETHODIMP InterfaceAliases::get_Item(long Index, IInterfaceAlias **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Alias> pPersAlias = aliases_->GetItem(Index);
...
STDMETHODIMP InterfaceAliases::Add(IInterfaceAlias **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Alias> pAliasADO = std::shared_ptr<MA::Alias>(new MA::Alias);
...
STDMETHODIMP InterfaceAliases::get_ItemByDBID(long DBID, IInterfaceAlias **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Alias> pPersAlias = aliases_->GetItemByDBID(DBID);
...
STDMETHODIMP InterfaceAliases::get_ItemByName(BSTR Name, IInterfaceAlias **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Alias> pPersAlias = aliases_->GetItemByName(Name);
