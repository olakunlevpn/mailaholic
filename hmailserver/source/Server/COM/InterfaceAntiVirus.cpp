...
InterfaceAntiVirus::InterfaceAntiVirus() :
   antiVirusConfiguration_(MA::Configuration::Instance()->GetAntiVirusConfiguration())
{
...
STDMETHODIMP InterfaceAntiVirus::get_Action(eAntivirusAction *pVal)
{
   try
   {
      ...
      {
      case MA::AntiVirusConfiguration::ActionDelete:
         *pVal = hDeleteEmail;
         break;
      case MA::AntiVirusConfiguration::ActionStripAttachments:
...
STDMETHODIMP InterfaceAntiVirus::put_Action(eAntivirusAction newVal)
{
   try
   {
      ...
      MA::AntiVirusConfiguration::eAVAction iAction;
      switch (newVal)
      {
      case hDeleteEmail:
         iAction = MA::AntiVirusConfiguration::ActionDelete;
         break;
      case hDeleteAttachments:
         iAction = MA::AntiVirusConfiguration::ActionStripAttachments;
      }
...
STDMETHODIMP InterfaceAntiVirus::get_BlockedAttachments(IInterfaceBlockedAttachments **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::BlockedAttachments> pBlockedAttachments = MA::Configuration::Instance()->GetBlockedAttachments();
...
STDMETHODIMP InterfaceAntiVirus::TestCustomerScanner(BSTR hostname, long port, BSTR *messageText, VARIANT_BOOL *pResult)
{
   try
   {
      ...
      MA::VirusScannerTester testClient;
