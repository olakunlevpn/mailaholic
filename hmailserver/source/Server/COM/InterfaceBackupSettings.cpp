...
STDMETHODIMP InterfaceBackupSettings::get_LogFile(BSTR *pVal)
{
   try
   {
      ...
      MA::String sLogDir = ini_file_settings_->GetLogDirectory();
...
InterfaceBackupSettings::get_BackupSettings(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetBackupOption(MA::Backup::BOSettings) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceBackupSettings::put_BackupSettings(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetBackupOption(MA::Backup::BOSettings, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
InterfaceBackupSettings::get_BackupDomains(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetBackupOption(MA::Backup::BODomains) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceBackupSettings::put_BackupDomains(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetBackupOption(MA::Backup::BODomains, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
InterfaceBackupSettings::get_BackupMessages(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetBackupOption(MA::Backup::BOMessages) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceBackupSettings::put_BackupMessages(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetBackupOption(MA::Backup::BOMessages, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
InterfaceBackupSettings::get_CompressDestinationFiles(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetBackupOption(MA::Backup::BOCompression) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceBackupSettings::put_CompressDestinationFiles(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetBackupOption(MA::Backup::BOCompression, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
