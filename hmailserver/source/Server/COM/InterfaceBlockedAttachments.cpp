...
void 
InterfaceBlockedAttachments::Attach(std::shared_ptr<MA::BlockedAttachments> pBA) 
{ 
...
InterfaceBlockedAttachments::get_Item(long Index, IInterfaceBlockedAttachment **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::BlockedAttachment> pBA = blocked_attachments_->GetItem(Index);
...
InterfaceBlockedAttachments::get_ItemByDBID(long lDBID, IInterfaceBlockedAttachment **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::BlockedAttachment> pBA = blocked_attachments_->GetItemByDBID(lDBID);
...
InterfaceBlockedAttachments::Add(IInterfaceBlockedAttachment **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::BlockedAttachment> pBA = std::shared_ptr<MA::BlockedAttachment>(new MA::BlockedAttachment);
