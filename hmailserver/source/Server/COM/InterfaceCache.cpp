...
InterfaceCache::get_DomainHitRate(long *pVal)
{
   try
   {
      ...
      *pVal = MA::Cache<MA::Domain>::Instance()->GetHitRate();
...
InterfaceCache::get_DomainCacheSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int) MA::CacheContainer::Instance()->GetDomainCacheSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::put_DomainCacheMaxSizeKb(long pVal)
{
   try
   {
      ...
      MA::CacheContainer::Instance()->SetDomainCacheMaxSize(pVal * 1024);
...
InterfaceCache::get_DomainCacheMaxSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int)MA::CacheContainer::Instance()->GetDomainCacheMaxSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::get_AccountHitRate(long *pVal)
{
   try
   {
      ...
      *pVal = MA::Cache<MA::Account>::Instance()->GetHitRate();
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::get_AccountCacheSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int)MA::CacheContainer::Instance()->GetAccountCacheSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::put_AccountCacheMaxSizeKb(long pVal)
{
   try
   {
      ...
      MA::CacheContainer::Instance()->SetAccountCacheMaxSize(pVal * 1024);
...
InterfaceCache::get_AccountCacheMaxSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int)MA::CacheContainer::Instance()->GetAccountCacheMaxSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::get_AliasHitRate(long *pVal)
{
   try
   {
      ...
      *pVal = MA::Cache<MA::Alias>::Instance()->GetHitRate();
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::get_AliasCacheSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int)MA::CacheContainer::Instance()->GetAliasCacheSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::put_AliasCacheMaxSizeKb(long pVal)
{
   try
   {
      ...
      MA::CacheContainer::Instance()->SetAliasCacheMaxSize(pVal * 1024);
...
InterfaceCache::get_AliasCacheMaxSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int)MA::CacheContainer::Instance()->GetAliasCacheMaxSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::get_DistributionListHitRate(long *pVal)
{
   try
   {
      ...
      *pVal = MA::Cache<MA::DistributionList>::Instance()->GetHitRate();
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::get_DistributionListCacheSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int)MA::CacheContainer::Instance()->GetDistributionListCacheSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::put_DistributionListCacheMaxSizeKb(long pVal)
{
   try
   {
      ...
      MA::CacheContainer::Instance()->SetDistributionListCacheMaxSize(pVal * 1024);
...
InterfaceCache::get_DistributionListCacheMaxSizeKb(long *pVal)
{
   try
   {
      ...
      *pVal = (int)MA::CacheContainer::Instance()->GetDistributionListCacheMaxSize() / 1024;
      return S_OK;
   }
   catch (...)
   {
...
InterfaceCache::Clear()
{
   try
   {
      ...
      MA::Cache<MA::Account>::Instance()->Clear();
      MA::Cache<MA::Domain>::Instance()->Clear();
      MA::Cache<MA::Alias>::Instance()->Clear();
      MA::Cache<MA::DistributionList>::Instance()->Clear();
      MA::MessagesContainer::Instance()->Clear();
