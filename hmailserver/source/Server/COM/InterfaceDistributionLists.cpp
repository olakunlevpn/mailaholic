...
void 
InterfaceDistributionLists::Attach(std::shared_ptr<MA::DistributionLists> pDistributionLists)
{
...
STDMETHODIMP InterfaceDistributionLists::Add(IInterfaceDistributionList **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::DistributionList> pPersList = std::shared_ptr<MA::DistributionList>(new MA::DistributionList);
...
STDMETHODIMP InterfaceDistributionLists::Delete(long Index)
{
   try
   {
      ...
      std::shared_ptr<MA::DistributionList> pPersList = distribution_lists_->GetItem(Index);
   
      MA::PersistentDistributionList::DeleteObject(pPersList);
...
STDMETHODIMP InterfaceDistributionLists::get_ItemByDBID(long DBID, IInterfaceDistributionList **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::DistributionList> pPersList = distribution_lists_->GetItemByDBID(DBID);
...
STDMETHODIMP InterfaceDistributionLists::get_ItemByAddress(BSTR sAddress, IInterfaceDistributionList **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::DistributionList> pPersList = distribution_lists_->GetItemByAddress(sAddress);
