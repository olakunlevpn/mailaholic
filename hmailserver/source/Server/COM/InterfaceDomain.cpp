...
void
InterfaceDomain::SetAuthentication(std::shared_ptr<MA::COMAuthentication> pAuthentication)
{
...
STDMETHODIMP InterfaceDomain::Save()
{
   try
   {
      ...
      if (MA::PersistentDomain::SaveObject(object_, sErrorMessage, MA::PersistenceModeNormal))
      {
...
STDMETHODIMP InterfaceDomain::get_Accounts(IInterfaceAccounts **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Accounts> pAccounts;
...
STDMETHODIMP InterfaceDomain::Delete()
{
   try
   {
      ...
      if (!parent_collection_)
         return MA::PersistentDomain::DeleteObject(object_) ? S_OK : S_FALSE;
...
STDMETHODIMP InterfaceDomain::get_Aliases(IInterfaceAliases **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Aliases> pAliases = object_->GetAliases();
      pAliases->Refresh();
...
STDMETHODIMP InterfaceDomain::get_DomainAliases(IInterfaceDomainAliases **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::DomainAliases> pDA = std::shared_ptr<MA::DomainAliases>(new MA::DomainAliases(object_->GetID()));
...
STDMETHODIMP InterfaceDomain::get_DistributionLists(IInterfaceDistributionLists **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::DistributionLists> pDistLists = object_->GetDistributionLists();
      pDistLists->Refresh();
...
STDMETHODIMP InterfaceDomain::get_Size(long *pVal)
{
   try
   {
      ...
      *pVal = MA::PersistentDomain::GetSize(object_);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceDomain::get_AllocatedSize(hyper  *pVal)
{
   try
   {
      ...
      *pVal = MA::PersistentDomain::GetAllocatedSize(object_);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceDomain::put_SignatureMethod(eDomainSignatureMethod newVal)
{
   try
   {
      ...
      if (!authentication_->GetIsDomainAdmin())
         return authentication_->GetAccessDenied();
      object_->SetSignatureMethod((MA::Domain::DomainSignatureMethod) newVal);
      return S_OK;
   }
   catch (...)
   {
