...
void
InterfaceDomains::SetAuthentication(std::shared_ptr<MA::COMAuthentication> pAuthentication)
{
...
STDMETHODIMP InterfaceDomains::Refresh()
{
   try
   {
      ...
      objects_ = std::shared_ptr<MA::Domains>(new MA::Domains);
...
STDMETHODIMP InterfaceDomains::get_ItemByName(BSTR ItemName, IInterfaceDomain **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Domain> pPersDomain = objects_->GetItemByName(ItemName);
...
STDMETHODIMP InterfaceDomains::get_Item(long Index, IInterfaceDomain **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Domain> pPersDomain = objects_->GetItem(Index);
...
STDMETHODIMP InterfaceDomains::get_ItemByDBID(long DBID, IInterfaceDomain **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Domain> pPersDomain = objects_->GetItemByDBID(DBID);
...
STDMETHODIMP InterfaceDomains::get_Names(BSTR *sNames)
{
   try
   {
      ...
      MA::String names = objects_->GetNames();
