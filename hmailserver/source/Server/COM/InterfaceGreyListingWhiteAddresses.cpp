...
void 
InterfaceGreyListingWhiteAddresses::Attach(std::shared_ptr<MA::GreyListingWhiteAddresses> pBA) 
{ 
...
InterfaceGreyListingWhiteAddresses::get_Item(long Index, IInterfaceGreyListingWhiteAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::GreyListingWhiteAddress> pBA = gl_white_addresses_->GetItem(Index);
...
InterfaceGreyListingWhiteAddresses::get_ItemByDBID(long lDBID, IInterfaceGreyListingWhiteAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::GreyListingWhiteAddress> pBA = gl_white_addresses_->GetItemByDBID(lDBID);
...
InterfaceGreyListingWhiteAddresses::get_ItemByName(BSTR sName, IInterfaceGreyListingWhiteAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::GreyListingWhiteAddress> pBA = gl_white_addresses_->GetItemByName(sName);
...
InterfaceGreyListingWhiteAddresses::Add(IInterfaceGreyListingWhiteAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::GreyListingWhiteAddress> pBA = std::shared_ptr<MA::GreyListingWhiteAddress>(new MA::GreyListingWhiteAddress);
