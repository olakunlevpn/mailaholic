...
void 
InterfaceGroups::Attach(std::shared_ptr<MA::Groups> pBA) 
{ 
   groups_ = pBA; 
}
...
InterfaceGroups::get_Item(long Index, IInterfaceGroup **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Group> pBA = groups_->GetItem(Index);
...
InterfaceGroups::get_ItemByDBID(long lDBID, IInterfaceGroup **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Group> pBA = groups_->GetItemByDBID(lDBID);
...
InterfaceGroups::get_ItemByName(BSTR sName, IInterfaceGroup **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Group> pBA = groups_->GetItemByName(sName);
...
InterfaceGroups::Add(IInterfaceGroup **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Group> pBA = std::shared_ptr<MA::Group>(new MA::Group);
