...
void 
InterfaceIMAPFolderPermissions::AttachItem(std::shared_ptr<MA::IMAPFolder> pFolder)
{
   folder_ = pFolder;
...
STDMETHODIMP InterfaceIMAPFolderPermissions::get_Item(long Index, IInterfaceIMAPFolderPermission **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::ACLPermission> pPersACLPermission = acl_permission_->GetItem(Index);
...
STDMETHODIMP InterfaceIMAPFolderPermissions::Add(IInterfaceIMAPFolderPermission **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::ACLPermission> pACLPermission = std::shared_ptr<MA::ACLPermission>(new MA::ACLPermission);
...
STDMETHODIMP InterfaceIMAPFolderPermissions::get_ItemByDBID(long DBID, IInterfaceIMAPFolderPermission **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::ACLPermission> pPersACLPermission = acl_permission_->GetItemByDBID(DBID);
...
STDMETHODIMP InterfaceIMAPFolderPermissions::get_ItemByName(BSTR Name, IInterfaceIMAPFolderPermission **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::ACLPermission> pPersACLPermission = acl_permission_->GetItemByName(Name);
