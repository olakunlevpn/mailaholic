...
void 
InterfaceIncomingRelays::Attach(std::shared_ptr<MA::IncomingRelays> incomingRelays)
{
...
STDMETHODIMP InterfaceIncomingRelays::get_Item(long Index, IInterfaceIncomingRelay **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::IncomingRelay> pRange = incoming_relays_->GetItem(Index);
...
STDMETHODIMP InterfaceIncomingRelays::get_ItemByDBID(long DBID, IInterfaceIncomingRelay **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::IncomingRelay> pRange = incoming_relays_->GetItemByDBID(DBID);
...
STDMETHODIMP InterfaceIncomingRelays::Add(IInterfaceIncomingRelay **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::IncomingRelay> pRange = std::shared_ptr<MA::IncomingRelay>(new MA::IncomingRelay); 
...
STDMETHODIMP InterfaceIncomingRelays::get_ItemByName(BSTR sName, IInterfaceIncomingRelay **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::IncomingRelay> pRange = incoming_relays_->GetItemByName(sName);
