...
InterfaceLogging::EnableLiveLogging(VARIANT_BOOL newVal)
{
   try
   {
      ...
      MA::Logger::Instance()->EnableLiveLogging(newVal == VARIANT_TRUE);
...
STDMETHODIMP InterfaceLogging::get_LiveLog(BSTR *pVal)
{
   try
   {
      ...
      *pVal = MA::Logger::Instance()->GetLiveLog().AllocSysString();
...
STDMETHODIMP InterfaceLogging::get_LiveLoggingEnabled(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = MA::Logger::Instance()->GetLiveLogEnabled();
...
STDMETHODIMP InterfaceLogging::get_CurrentEventLog(BSTR *pVal)
{
   try
   {
      ...
      *pVal = MA::Logger::Instance()->GetCurrentLogFileName(MA::Logger::Events).AllocSysString();
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceLogging::get_CurrentErrorLog(BSTR *pVal)
{
   try
   {
      ...
      *pVal = MA::Logger::Instance()->GetCurrentLogFileName(MA::Logger::Error).AllocSysString();
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceLogging::get_CurrentAwstatsLog(BSTR *pVal)
{
   try
   {
      ...
      *pVal = MA::Logger::Instance()->GetCurrentLogFileName(MA::Logger::AWStats).AllocSysString();
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceLogging::get_CurrentDefaultLog(BSTR *pVal)
{
   try
   {
      ...
      *pVal = MA::Logger::Instance()->GetCurrentLogFileName(MA::Logger::Normal).AllocSysString();
      return S_OK;
   }
   catch (...)
   {
