...
STDMETHODIMP InterfaceRoute::Save()
{
   try
   {
      ...
      if (MA::PersistentRoute::SaveObject(object_, sErrorMessage, MA::PersistenceModeNormal))
      {
...
STDMETHODIMP InterfaceRoute::get_Addresses(IInterfaceRouteAddresses **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::RouteAddresses> pAdresses = object_->GetAddresses();
...
STDMETHODIMP InterfaceRoute::put_RelayerAuthUsername(BSTR newVal)
{
   try
   {
      ...
      object_->SetRelayerAuthUsername(MA::String(newVal));
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceRoute::SetRelayerAuthPassword(BSTR newVal)
{
   try
   {
      ...
      object_->SetRelayerAuthPassword(MA::String(newVal));
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceRoute::Delete()
{
   try
   {
      ...
      if (!parent_collection_)
         return MA::PersistentRoute::DeleteObject(object_) ? S_OK : S_FALSE;
