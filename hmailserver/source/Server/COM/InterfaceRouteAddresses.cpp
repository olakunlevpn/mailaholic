...
void
InterfaceRouteAddresses::Attach(std::shared_ptr<MA::RouteAddresses> pRouteAddresses)
{
...
InterfaceRouteAddresses::get_Item(long Index, IInterfaceRouteAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::RouteAddress> pRouteAddress = route_addresses_->GetItem(Index);
...
InterfaceRouteAddresses::Add(IInterfaceRouteAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::RouteAddress> pRouteAddress = std::shared_ptr<MA::RouteAddress>(new MA::RouteAddress);
...
InterfaceRouteAddresses::get_ItemByDBID(long lDBID, IInterfaceRouteAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::RouteAddress> pRouteAddress = route_addresses_->GetItemByDBID(lDBID);
