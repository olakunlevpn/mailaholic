...
STDMETHODIMP InterfaceRuleCriteria::Save()
{
   try
   {
      ...
      {
         if (!MA::PersistentRuleCriteria::SaveObject(object_))
         {
            // Saving failed.
...
STDMETHODIMP InterfaceRuleCriteria::put_PredefinedField(eRulePredefinedField newVal)
{
   try
   {
      ...
      object_->SetPredefinedField((MA::RuleCriteria::PredefinedField)newVal);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceRuleCriteria::put_MatchType(eRuleMatchType newVal)
{
   try
   {
      ...
      object_->SetMatchType((MA::RuleCriteria::MatchType)newVal);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceRuleCriteria::Delete()
{
   try
   {
      ...
      if (!parent_collection_)
         return MA::PersistentRuleCriteria::DeleteObject(object_) ? S_OK : S_FALSE;
