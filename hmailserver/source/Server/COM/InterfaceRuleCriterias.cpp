...
void 
InterfaceRuleCriterias::Attach(std::shared_ptr<MA::RuleCriterias> pCriterias)
{
...
STDMETHODIMP InterfaceRuleCriterias::get_ItemByDBID(long lDBID, IInterfaceRuleCriteria** pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::RuleCriteria> pRule = rule_criterias->GetItemByDBID(lDBID);
      if (!pRule)
...
STDMETHODIMP InterfaceRuleCriterias::get_Item(long lIndex, IInterfaceRuleCriteria** pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::RuleCriteria> pRule = rule_criterias->GetItem(lIndex);
      if (!pRule)
         return DISP_E_BADINDEX;
...
STDMETHODIMP InterfaceRuleCriterias::Add(IInterfaceRuleCriteria** pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::RuleCriteria> pDA = std::shared_ptr<MA::RuleCriteria>(new MA::RuleCriteria);
