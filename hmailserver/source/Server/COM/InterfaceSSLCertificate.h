...
class ATL_NO_VTABLE InterfaceSSLCertificate :
   public COMCollectionItem<MA::SSLCertificate, MA::SSLCertificates>,
...
public:
   ...
   STDMETHOD(get_CertificateFile)(/*[out, retval]*/ BSTR *pVal);
   STDMETHOD(put_CertificateFile)(/*[in]*/ BSTR newVal);
