...
void 
InterfaceSSLCertificates::Attach(std::shared_ptr<MA::SSLCertificates> pBA) 
{ 
...
InterfaceSSLCertificates::get_Item(long Index, IInterfaceSSLCertificate **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SSLCertificate> pBA = ssl_certificates_->GetItem(Index);
...
InterfaceSSLCertificates::get_ItemByDBID(long lDBID, IInterfaceSSLCertificate **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SSLCertificate> pBA = ssl_certificates_->GetItemByDBID(lDBID);
...
InterfaceSSLCertificates::Add(IInterfaceSSLCertificate **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SSLCertificate> pBA = std::shared_ptr<MA::SSLCertificate>(new MA::SSLCertificate);
