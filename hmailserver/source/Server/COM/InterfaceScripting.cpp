...
STDMETHODIMP InterfaceScripting::Reload(void)
{
   try
   {
      ...
      MA::ScriptServer::Instance()->LoadScripts();
...
STDMETHODIMP InterfaceScripting::CheckSyntax(BSTR *pVal)
{
   try
   {
      ...
      *pVal = MA::ScriptServer::Instance()->CheckSyntax().AllocSysString();
...
STDMETHODIMP InterfaceScripting::get_CurrentScriptFile(BSTR *pVal)
{
   try
   {
      ...
      *pVal = MA::ScriptServer::Instance()->GetCurrentScriptFile().AllocSysString();
      return S_OK;
   }
   catch (...)
   {
