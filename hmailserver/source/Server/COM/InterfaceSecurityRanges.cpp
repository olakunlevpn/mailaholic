...
InterfaceSecurityRanges::LoadSettings()
{
   ...
   security_ranges_ = std::shared_ptr<MA::SecurityRanges> (new MA::SecurityRanges);
...
STDMETHODIMP InterfaceSecurityRanges::get_Item(long Index, IInterfaceSecurityRange **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SecurityRange> pRange = security_ranges_->GetItem(Index);
...
STDMETHODIMP InterfaceSecurityRanges::get_ItemByDBID(long DBID, IInterfaceSecurityRange **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SecurityRange> pRange = security_ranges_->GetItemByDBID(DBID);
...
STDMETHODIMP InterfaceSecurityRanges::Add(IInterfaceSecurityRange **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SecurityRange> pRange = std::shared_ptr<MA::SecurityRange>(new MA::SecurityRange); 
...
STDMETHODIMP InterfaceSecurityRanges::get_ItemByName(BSTR sName, IInterfaceSecurityRange **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SecurityRange> pRange = security_ranges_->GetItemByName(sName);
