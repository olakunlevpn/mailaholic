...
InterfaceServerMessages::LoadSettings()
{
   ...
   server_messages_ = MA::Configuration::Instance()->GetServerMessages();
...
InterfaceServerMessages::get_Item(long Index, IInterfaceServerMessage **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::ServerMessage> pSM = server_messages_->GetItem(Index);
...
InterfaceServerMessages::get_ItemByDBID(long lDBID, IInterfaceServerMessage **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::ServerMessage> pSM = server_messages_->GetItemByDBID(lDBID);
...
InterfaceServerMessages::get_ItemByName(BSTR sName, IInterfaceServerMessage **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::ServerMessage> pSM = server_messages_->GetItemByName(sName);
