...
STDMETHODIMP InterfaceSettings::get_TCPIPPorts(IInterfaceTCPIPPorts **pVal)
{
   try
   {
      ...
      pItem->SetAuthentication(authentication_);
      pItem->Attach(MA::Configuration::Instance()->GetTCPIPPorts());
...
STDMETHODIMP InterfaceSettings::get_SSLCertificates(IInterfaceSSLCertificates **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::SSLCertificates> pSSLCertificates = MA::Configuration::Instance()->GetSSLCertificates();
...
STDMETHODIMP InterfaceSettings::get_SMTPRelayerUseSSL(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetSMTPConfiguration()->GetSMTPRelayerConnectionSecurity() == MA::CSSSL? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::put_SMTPRelayerUseSSL(VARIANT_BOOL newVal)
{
   try
   {
      ...
      if (newVal == VARIANT_TRUE)
         config_->GetSMTPConfiguration()->SetSMTPRelayerConnectionSecurity(MA::CSSSL);
      else
         config_->GetSMTPConfiguration()->SetSMTPRelayerConnectionSecurity(MA::CSNone);
...
STDMETHODIMP InterfaceSettings::put_SMTPRelayerConnectionSecurity(eConnectionSecurity newVal)
{
   try
   {
      ...
      config_->GetSMTPConfiguration()->SetSMTPRelayerConnectionSecurity((MA::ConnectionSecurity) newVal);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::put_SMTPConnectionSecurity(eConnectionSecurity newVal)
{
   try
   {
      ...
      config_->GetSMTPConfiguration()->SetSMTPConnectionSecurity((MA::ConnectionSecurity) newVal);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::get_PublicFolders(IInterfaceIMAPFolders **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::IMAPFolders> pIMAPFolders = MA::Configuration::Instance()->GetIMAPConfiguration()->GetPublicFolders();
...
STDMETHODIMP InterfaceSettings::get_Groups(IInterfaceGroups **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::Groups> pGroups = config_->GetIMAPConfiguration()->GetGroups();
      pGroups->Refresh();
...
STDMETHODIMP InterfaceSettings::get_IncomingRelays(IInterfaceIncomingRelays **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::IncomingRelays> incomingRelays = config_->GetSMTPConfiguration()->GetIncomingRelays();
...
STDMETHODIMP InterfaceSettings::put_TlsVersion10Enabled(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetSslVersionEnabled(MA::TlsVersion10, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::get_TlsVersion10Enabled(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetSslVersionEnabled(MA::TlsVersion10) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::put_TlsVersion11Enabled(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetSslVersionEnabled(MA::TlsVersion11, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::get_TlsVersion11Enabled(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetSslVersionEnabled(MA::TlsVersion11) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::put_TlsVersion12Enabled(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetSslVersionEnabled(MA::TlsVersion12, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::get_TlsVersion12Enabled(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetSslVersionEnabled(MA::TlsVersion12) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::put_TlsVersion13Enabled(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetSslVersionEnabled(MA::TlsVersion13, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::get_TlsVersion13Enabled(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetSslVersionEnabled(MA::TlsVersion13) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::put_TlsOptionPreferServerCiphersEnabled(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetTlsOptionEnabled(MA::TlsOptionPreferServerCiphers, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::get_TlsOptionPreferServerCiphersEnabled(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetTlsOptionEnabled(MA::TlsOptionPreferServerCiphers) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::put_TlsOptionPrioritizeChaChaEnabled(VARIANT_BOOL newVal)
{
   try
   {
      ...
      config_->SetTlsOptionEnabled(MA::TlsOptionPrioritizeChaCha, newVal == VARIANT_TRUE);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceSettings::get_TlsOptionPrioritizeChaChaEnabled(VARIANT_BOOL *pVal)
{
   try
   {
      ...
      *pVal = config_->GetTlsOptionEnabled(MA::TlsOptionPrioritizeChaCha) ? VARIANT_TRUE : VARIANT_FALSE;
      return S_OK;
   }
   catch (...)
   {
