...
InterfaceTCPIPPort::Save()
{
   try
   {
      ...
      MA::String error_message;
      if (MA::PersistentTCPIPPort::SaveObject(object_, error_message, MA::PersistenceModeNormal))
      {
...
STDMETHODIMP InterfaceTCPIPPort::put_Protocol(eSessionType newVal)
{
   try
   {
      ...
      object_->SetProtocol((MA::SessionType) newVal);
      return S_OK;
   }
   catch (...)
   {
...
STDMETHODIMP InterfaceTCPIPPort::get_Address(BSTR *pVal)
{
   try
   {
      ...
      MA::String sIPAddress = object_->GetAddressString();
...
STDMETHODIMP InterfaceTCPIPPort::Delete()
{
   try
   {
      ...
      if (!parent_collection_)
         return MA::PersistentTCPIPPort::DeleteObject(object_) ? S_OK : S_FALSE;
