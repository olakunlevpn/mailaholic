...
void 
InterfaceTCPIPPorts::Attach(std::shared_ptr<MA::TCPIPPorts> pBA) 
{ 
   tcpip_ports_ = pBA; 
}
...
InterfaceTCPIPPorts::get_Item(long Index, IInterfaceTCPIPPort **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::TCPIPPort> pBA = tcpip_ports_->GetItem(Index);
...
InterfaceTCPIPPorts::get_ItemByDBID(long lDBID, IInterfaceTCPIPPort **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::TCPIPPort> pBA = tcpip_ports_->GetItemByDBID(lDBID);
...
InterfaceTCPIPPorts::Add(IInterfaceTCPIPPort **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::TCPIPPort> pBA = std::shared_ptr<MA::TCPIPPort>(new MA::TCPIPPort);
