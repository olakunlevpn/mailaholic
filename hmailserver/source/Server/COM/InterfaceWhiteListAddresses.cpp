...
void 
InterfaceWhiteListAddresses::Attach(std::shared_ptr<MA::WhiteListAddresses> pBA) 
{ 
   object_ = pBA; 
}
...
InterfaceWhiteListAddresses::get_Item(long Index, IInterfaceWhiteListAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::WhiteListAddress> pBA = object_->GetItem(Index);
...
InterfaceWhiteListAddresses::get_ItemByDBID(long lDBID, IInterfaceWhiteListAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::WhiteListAddress> pBA = object_->GetItemByDBID(lDBID);
...
InterfaceWhiteListAddresses::get_ItemByName(BSTR sName, IInterfaceWhiteListAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::WhiteListAddress> pBA = object_->GetItemByName(sName);
...
InterfaceWhiteListAddresses::Add(IInterfaceWhiteListAddress **pVal)
{
   try
   {
      ...
      std::shared_ptr<MA::WhiteListAddress> pBA = std::shared_ptr<MA::WhiteListAddress>(new MA::WhiteListAddress);
