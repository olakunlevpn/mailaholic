...
namespace MA
{
   ...
   {
      const MA::String directoryName = MA::FileUtilities::GetFilePath(fileName);
      if (!MA::FileUtilities::Exists(directoryName))
         MA::FileUtilities::CreateDirectory(directoryName);
