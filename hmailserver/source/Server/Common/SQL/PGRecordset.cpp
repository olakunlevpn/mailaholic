...
namespace MA
{
   ...
   {  
      ...
      {
         ErrorManager::Instance()->ReportError(MA::ErrorManager::High, 5085, "PGConnection::TryOpen", "An unknown error occurred while executing" + sSQL);
         throw;
      }
   ...
   //---------------------------------------------------------------------------()
   {
      ...
      {
         ErrorManager::Instance()->ReportError(MA::ErrorManager::High, 5086, "PGConnection::Close", "An unknown error occurred while closing recordset.");
         throw;
      }
   ...
   //---------------------------------------------------------------------------()
   {
      if (!result_)
      {
         ...
         ErrorManager::Instance()->ReportError(MA::ErrorManager::High, 5093, "PGConnection::Close", "An unknown error occurred while closing recordset.");
         return 0;
      }
