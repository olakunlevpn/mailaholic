...
namespace MA
{
   ...
   ClassTester::DoTests()
   {
      ...
      OutputDebugString(_T("Mailaholic: Testing mime parser\n"));
	   MimeTester *pMimeTester = new MimeTester;
      pMimeTester->Test();
	   delete pMimeTester;

      OutputDebugString(_T("Mailaholic: Testing StringParser\n"));
      StringParserTester *pParser = new StringParserTester();
      pParser->Test();
      delete pParser;
  
      OutputDebugString(_T("Mailaholic: Testing FileUtilities\n"));
      FileUtilitiesTester fileUtilitiesTester;
      fileUtilitiesTester.Test();

      OutputDebugString(_T("Mailaholic: Testing IPAddress\n"));
      IPAddressTester ipAddressTester;
      ipAddressTester.Test();

      OutputDebugString(_T("Mailaholic: Testing MessageUtilities\n"));
      MessageUtilitiesTester messageUtilitiesTester;
      messageUtilitiesTester.Test();

      OutputDebugString(_T("Mailaholic: Testing Formatter\n"));
      FormatterTester formatterTester;
      formatterTester.Test();

      OutputDebugString(_T("Mailaholic: Testing TimeoutCalculator\n"));
      TimeoutCalculatorTester timeoutCalculatortester;
      timeoutCalculatortester.Test();

      OutputDebugString(_T("Mailaholic: Test DateTime\n"));
      DateTimeTests tests;
      tests.Test();

      OutputDebugString(_T("Mailaholic: Testing Utilities\n"));
      UtilitiesTester *pTestUtilities = new UtilitiesTester();
      pTestUtilities->Test();
      delete pTestUtilities;

      OutputDebugString(_T("Mailaholic: Test BLChecktester\n"));
      BLCheckTester blchecktester;
      blchecktester.Test();

      OutputDebugString(_T("Mailaholic: Testing SPF\n"));
      SPFTester *pSPF = new SPFTester();
      pSPF->Test();
      delete pSPF;

      OutputDebugString(_T("Mailaholic: Testing SHA256\n"));
      HashCreatorTester tester;
      tester.Test();


      OutputDebugString(_T("Mailaholic: Testing RegularExpressionTester\n"));
      RegularExpressionTester *pRegExTest = new RegularExpressionTester();
      pRegExTest->Test();
      delete pRegExTest;

      OutputDebugString(_T("Mailaholic: Testing Base64\n"));
      ...
      OutputDebugString(_T("Mailaholic: Testing AddresslistParser\n"));
      AddresslistParserTester *pTest2 = new AddresslistParserTester();
      pTest2->Test();
      delete pTest2;

      OutputDebugString(_T("Mailaholic: Testing charset\n"));
      CharsetTester *pCharsetTester = new CharsetTester;
      pCharsetTester->Test();
      delete pCharsetTester;


      OutputDebugString(_T("Mailaholic: Testing LocalIPAddresses\n"));
      LocalIPAddressesTester *pTest4 = new LocalIPAddressesTester();
      pTest4->Test();
      delete pTest4;

      OutputDebugString(_T("Mailaholic: Testing MessageData\n"));
      MessageDataTester *pMsgData = new MessageDataTester();
      pMsgData->Test();
      delete pMsgData;

      OutputDebugString(_T("Mailaholic: Testing Time\n"));
      ...
      OutputDebugString(_T("Mailaholic: Testing BlowFishEncryptorTester\n"));
      BlowFishEncryptorTester *pTest3 = new BlowFishEncryptorTester();
      pTest3->Test();
      delete pTest3;

      OutputDebugString(_T("Mailaholic: Testing IMAPSimpleCommandParserTester\n"));
