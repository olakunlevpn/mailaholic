...
// bro      2002-10-29
//========================================================
void _SetString( LPTSTR psz, LPTSTR end, MA::String* ps, bool trim = FALSE, int escape = 0 )
{
	//trim
	if( trim )
	{
...
LPTSTR _tagXMLDocument::Load( LPCTSTR pszXml, LPPARSEINFO pi /*= NULL*/ )
{
	...
	if( (end = node->Load( pszXml, pi )) == NULL )
	{
      ...
      if (pi->erorr_occur == true)
      {
         ...
         MA::ErrorManager::Instance()->ReportError(MA::ErrorManager::Medium, 4229, "_tagXMLDocument::Load", sErrorMessage);
      }
...
// bro      2002-10-29
//========================================================
MA::String _tagXMLAttr::GetXML( LPDISP_OPT opt /*= &optDefault*/ )
{
   MA::String sRetVal;
...
// bro      2002-10-29
//========================================================
MA::String _tagXMLNode::GetXML( LPDISP_OPT opt /*= &optDefault*/ )
{
   MA::String sRetVal;
...
// �����   2004-06-15
//========================================================
MA::String _tagXMLNode::GetText( LPDISP_OPT opt /*= &optDefault*/ )
{
...
// bro      2002-10-29
//========================================================
MA::String _tagXMLNode::GetAttrValue( LPCTSTR attrname )
{
...
MA::String	_tagXMLNode::GetChildText( LPCTSTR name, LPDISP_OPT opt /*= &optDefault*/ )
{
	LPXNode node = GetChild( name );
...
MA::String tagXMLEntitys_::Ref2Entity( LPCTSTR estr )
{
	MA::String es;
	if( estr )
	{
...
MA::String tagXMLEntitys_::Entity2Ref( LPCTSTR str )
{
	MA::String s;
	if( str )
	{
...
MA::String XRef2Entity( LPCTSTR estr )
{
	return entityDefault.Ref2Entity( estr );
}

MA::String XEntity2Ref( LPCTSTR str )
{
