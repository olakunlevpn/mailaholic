...
{
   IMAPResult
   IMAPCommandDELETE::ExecuteCommand(std::shared_ptr<MA::IMAPConnection> pConnection, std::shared_ptr<IMAPCommandArgument> pArgument)
   {
   ...
   */
   void IMAPCommandDELETE::RemoveFolder_( std::shared_ptr<IMAPFolder> pFolder, std::shared_ptr<MA::IMAPConnection>  pConnection )
   {
