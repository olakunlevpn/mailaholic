...
{
   IMAPResult
   IMAPCommandRENAME::ExecuteCommand(std::shared_ptr<MA::IMAPConnection> pConnection, std::shared_ptr<IMAPCommandArgument> pArgument)
   {
   ...
   IMAPCommandRENAME::GetParentFolder(std::shared_ptr<MA::IMAPConnection> pConnection, const std::vector<String> &vecFolderPath)
   {
   ...
   IMAPResult
   IMAPCommandRENAME::ConfirmPossibleToRename(std::shared_ptr<MA::IMAPConnection> pConnection, std::shared_ptr<IMAPFolder> pFolderToRename, const std::vector<String> &vecOldPath, const std::vector<String> &vecNewPath)
   {
