   ...
   public :
      ...
      RegisterObjects()
      {
         ...
         if (FAILED(hr))
         {
            ...
            ErrorManager::Instance()->ReportError(ErrorManager::Medium, 5078, "Mailaholic::RegisterObjects", sErrorMessage);
         ...
         if (FAILED(hr))
         {
            ...
            ErrorManager::Instance()->ReportError(ErrorManager::Medium, 5079, "Mailaholic::RegisterObjects", sErrorMessage);
      ...
      ResumeObjects()
      {
         ...
         if (FAILED(hr))
         {
            ...
            ErrorManager::Instance()->ReportError(ErrorManager::Medium, 5080, "Mailaholic::ResumeObjects", sErrorMessage);
      ...
      //------------------------------------------------------------------------//
      {
         ...
         key.SetStringValue(_T("LocalService"), _T("Mailaholic"));
         if (lRes != ERROR_SUCCESS)
            return AtlHresultFromWin32(lRes);
...
MA::ChMailServerModule _AtlModule;
                                ...
                                LPTSTR lpCmdLine, int nShowCmd)
{
   ...
   MA::String sCommandLine = GetCommandLine();
   ...
   if (bRegisterService)
   {
      ...
      MA::ServiceManager hSCM;
      if (!hSCM.RegisterService("Mailaholic", "Mailaholic"))
      {
         return -1;         
      }
   }
   ...
   {
      // ---  Unregister the Mailaholic service.
      MA::ServiceManager hSCM;
      hSCM.UnregisterService("Mailaholic");
   ...
   if (sLastParam.CompareNoCase(_T("/Test")) == 0)
   {
      ...
      DEBUG_MODE = true;
	   ...
	   String sErrorMessage;
      if (MA::Application::Instance()->InitInstance(sErrorMessage))
      {
         ...
         MA::Application::Instance()->StartServers();
      }
      ...
      MA::Application::Instance()->ExitInstance();
   }
...
//------------------------------------------------------------------------//
{
   ...
   ServiceStatusHandle = RegisterServiceCtrlHandler(_T("Mailaholic"), ServiceController); 
