...
$libsPath = $env:MailaholicLibs

if ([string]::isnullorempty($libspath))
{
    Throw "The environment variable MailaholicLibs was not found. Please create it."
}

if (!(Test-Path $libsPath))
{
    Throw "The environment variable MailaholicLibs was found, but the folder it was pointing at ($libsPath) was not. Please create it."
}
